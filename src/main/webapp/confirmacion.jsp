	...
	<main>
		...
		<div class="card text-center w-50 m-auto mt-5">
			...
			<div class="card-body">
				...
				<a
					href="edicion.jsp?nombre=<%=nombre%>&apellido=<%=apellido%>&email=<%=email%>&cantidad=<%=cantidad%>&categoria=<%=categoria%>"
					class="btn btn-warning">Editar</a> <a href="comprar.html"
					class="btn btn-primary">Listo</a>
